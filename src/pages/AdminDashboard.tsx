...
const AdminDashboard: React.FC = () => {
  ...
  const handleEditMechanic = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabase
        ...
        .insert({
          type: 'general',
          message: `Mecânico ${mechanicForm.full_name} foi atualizado pelo ADMEC - Cargo: ${mechanicForm.position}, Status: ${mechanicForm.approved ? 'Aprovado' : 'Pendente'}`,
          is_read: false
        });
  ...
  const handleEditClient = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabase
        ...
        .insert({
          type: 'general',
          message: `Cliente ${clientForm.full_name} foi atualizado pelo ADMEC`,
          is_read: false
        });
  ...
  const deleteMechanic = async (mechanicId: string, mechanicName: string) => {
    if (!confirm(`Tem certeza que deseja EXCLUIR PERMANENTEMENTE a conta do mecânico ${mechanicName}? Esta ação não pode ser desfeita.`)) return;
    ...
    try {
      ...
      await supabase
        ...
        .insert({
          type: 'general',
          message: `Conta do mecânico ${mechanicName} foi EXCLUÍDA pelo ADMEC`,
          is_read: false
        });
  ...
  const deleteClient = async (clientId: string, clientName: string) => {
    if (!confirm(`Tem certeza que deseja EXCLUIR PERMANENTEMENTE a conta do cliente ${clientName}? Esta ação não pode ser desfeita.`)) return;
    ...
    try {
      ...
      await supabase
        ...
        .insert({
          type: 'general',
          message: `Conta do cliente ${clientName} foi EXCLUÍDA pelo ADMEC`,
          is_read: false
        });
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-white font-bold text-lg">PAINEL DO ADMEC</h1>
                  <p className="text-red-400 text-sm">Controle Total do Sistema</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-right">
              ...
              <p className="text-red-400 text-sm">Administrador</p>
            </div>
          </div>
        </div>
      </div>
        ...
        {activeTab === 'overview' && (
          ...
          >
            ...
            <div className="bg-red-600/10 border border-red-600 rounded-xl p-6">
              <h3 className="text-xl font-bold text-red-400 mb-4">Permissões do ADMEC</h3>
